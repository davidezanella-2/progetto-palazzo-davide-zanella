...
#ifndef UNTITLED1_PALAZZO2_H
#define UNTITLED1_PALAZZO2_H
#include <iostream>
#include "Stanza.h"
...
class Palazzo2{
private:
    std::vector <Stanza> st;

public:
    Palazzo2(int dimensione, Stanza *stanze);
    Palazzo2 (std::vector <Stanza> st);
